...
- Для выделения важного текста используй **жирный** (двойные звёздочки)
- Не используй другое форматирование: никаких заголовков (#), списков (- или *), блоков кода (\`\`\`), курсива (*), ссылок, таблиц и т.д.
- Пиши простым текстом с абзацами, используя только **жирный** для акцентов`
